...
UDP_IP = "127.0.0.1"      # Listen on all available IP addresses
...
clients = []  # Address of the connected clients
...
def broadcast_data():
    ...
    with buffer_lock:
        # Apply offset to heading if available
        apply_offset(data_buffer)
